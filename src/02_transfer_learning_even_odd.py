...
## To predict given digit is even or odd

STAGE = "Transfer Learning for even-odd classifier" ## <<< change stage name 

logging.basicConfig(
    filename=os.path.join("logs", 'Transfer_learning_even_odd.log'), 
    level=logging.INFO, 
...
def main(config_path):
    ...
    y_train_bin, y_test_bin, y_valid_bin = get_labels([y_train,y_test,y_valid],'even_odd')
    ...
    ## saving model file
    model_name ='even_odd_clf_model.h5'
    
    save_model(new_model, model_name, model_dir_path)

    ## plotting model performance
    plot_name = 'even_odd_model_plot.png'
